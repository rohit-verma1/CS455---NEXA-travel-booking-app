...
import { User, UserCheck, Briefcase, Users, LogOut, Menu, Bell, Github, Clock } from "lucide-react";
    ...
    <>
      <header className="w-full sticky top-0 z-40 bg-white border-b border-slate-100">
        <div className="flex items-center h-20 px-6">
          ...
          {/* Center section: Booking progress bar if on booking page, else empty flex-grow */}
          <div className="flex-1 flex justify-center items-center gap-6">
            {pathname.startsWith("/booking/") && <BookingProgress />}
